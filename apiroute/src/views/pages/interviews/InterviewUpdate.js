...
let InterviewUpdate = {
    render: async () => {
        ...
        let view = /*html*/`
        <form class="simple_form edit_interview" id="edit_interview" novalidate="novalidate" enctype="multipart/form-data" action="/interviews/id" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="patch">
